...
const proseStyles = [
    ...
    "prose-headings:font-outfit prose-headings:text-card-foreground prose-headings:mt-10 prose-headings:mb-4",
    "prose-a:text-blue-600 prose-a:after:content-['_↗'] prose-a:font-outfit prose-a:underline",
        ...
        <div className="h-full pt-20 min-h-[calc(100vh-2.5rem)] my-auto">
            <div className="flex flex-col pt-20">
                ...
                <Card className="m-4 sm:px-10 py-8 sm:py-16">
                    <CardContent>
                        <h1 className="md:text-6xl sm:text-5xl text-4xl font-outfit font-semibold">{(blog && blog.title) || "untitled blog post"}{!blog.approved && <span className="text-muted-foreground"> (draft)</span>}</h1>
                        <CardDescription>
